------------------------------------------------------------------------------------------------------------------------
Program: Tree based static voting protocol for replica consistency 
Author: Sanket Chandorkar and Ashish gupta
------------------------------------------------------------------------------------------------------------------------
...
order, add safeguards to prevent such a possibility. You need to instrument your code such that if these safeguards get
...
------------------------------------------------------------------------------------------------------------------------
Refer:
1. documentation\Voting_Protocol.pdf
